#!/usr/bin/env bash
#
# SOURCE: https://github.com/fsaintjacques/semver-tool
#
# To use this as a library file the following functions have been renamed:
# command-bump    -> semver-bump
# command-get     -> semver-get
# command-compare -> semver-compare
